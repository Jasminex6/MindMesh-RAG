...
RELEVANCE_THRESHOLD: float = 0.40  # Minimum top cosine similarity score in Chroma vector store to be considered in-scope
...
def default_config(project_root: Path | str) -> RagConfig:
    ...
    config = RagConfig(
        ...
        sources=(
            ...
            SourceSpec(
                file_name="GINA Asthma WMS.pdf",
                document="GINA-Summary-Guide-2026-WEB-WMS",
                publisher="Global Initiative for Asthma (GINA)",
                source_url="https://ginasthma.org/",
                usage_note=(
                    "Official 2026 GINA Summary Guide for Asthma Management and Prevention. "
                    "Covers adults, adolescents, and children 6-11 years (does NOT cover children under 6)."
                ),
            ),
        ),
    )
